...
# ###
"""The application object and various web framework like utilities."""
import re
...
def _setting_to_bool(value):
    ...
    value = value.lower()
    result = False
    if value.startswith('t') or value == 'on' or value == '1':
        result = True
    return result
...
class Application:
    ...
    def is_in_dev_mode(self):
        ...
        return settings.get('dev-mode', False)
